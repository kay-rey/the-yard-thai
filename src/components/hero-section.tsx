		...
		<section className="relative h-[calc(100dvh-4rem)] w-full overflow-hidden">
			...
			<div className="relative z-10 flex h-full items-center justify-center">
				<div className="mx-auto max-w-6xl px-4 text-center">
					...
					<h1 className="mb-6 text-7xl sm:text-6xl md:text-7xl lg:text-8xl font-serif text-white leading-tight animate-fade-in-up">
					...
					<p
						className="mb-4 text-4xl font-parisienne text-white/90 animate-fade-in-up"
					...
					<div
						className="flex flex-col gap-4 sm:flex-row sm:justify-center sm:gap-6 animate-fade-in-up"
